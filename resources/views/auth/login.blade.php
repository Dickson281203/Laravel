...
<head>
    ...
    <title>Login</title>
    <link href="vendor/plugins/aos/aos.min.css" rel="stylesheet">
    <link href="vendor/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="vendor/plugins/fontawesome/css/all.min.css" rel="stylesheet">
    <link href="vendor/plugins/OwlCarousel2/css/owl.carousel.min.css" rel="stylesheet">
    <link href="vendor/plugins/OwlCarousel2/css/owl.theme.default.min.css" rel="stylesheet">
    <link href="vendor/plugins/jquery-fancyfileuploader/fancy-file-uploader/fancy_fileupload.css" rel="stylesheet">
    <link href="vendor/plugins/ion.rangeSlider/ion.rangeSlider.min.css" rel="stylesheet">
    <link href="vendor/plugins/magnific-popup/magnific-popup.css" rel="stylesheet">
    <link href="vendor/plugins/select2/select2.min.css" rel="stylesheet">
    <link href="vendor/plugins/select2-bootstrap-5/select2-bootstrap-5-theme.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="row g-4 g-xl-5 justify-content-between">
            <div class="col-xl-10 d-flex justify-content-center">
                <div class="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
                    ...
                    <!-- /.End Header Text -->
                    <!-- Start Text -->
                    <p class="mb-4">We won't post anything without your permission and your personal details are kept
                        private</p>
                    <!-- /.End Text -->
                    ...
                    <!-- Start Bottom Text -->
                    <div class="bottom-text text-center mt-4"> Don't have an account? <a href="{{ route('auth.register') }}" class="fw-medium text-decoration-underline">Sign up</a>
                        <br> Remind? <a href="{{ route('auth.forgotpassword') }}" class="fw-medium text-decoration-underline">Password</a>
                    </div>
                    <!-- /.End Bottom Text -->
                </div>
            </div>
            <!-- <div class="col-xl-7 d-none d-xl-block">
                <div class="background-image bg-light d-flex flex-column h-100 justify-content-center p-5 rounded-4" data-image-src="vendor/images/lines.svg">
                    <div class="py-5 text-center">
                        ...
                        <img src="vendor/images/png-img/login.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div> -->
        </div>
                    ...
                    <div class="col-xxl-10 col-md-11 col-10 d-flex flex-md-row flex-column-reverse align-items-md-end align-items-center mx-auto px-0 gap-4">
                        <div class="align-items-lg-center align-self-center d-flex flex-column flex-lg-row ps-xxl-4 pt-5 py-md-3 text-center text-md-start">
                            <div class="me-md-5">
                                ...
                                <p class="mb-lg-0 text-white">It is a long established fact that a reader will be
            ...
            <div class="border-top py-5">
                <div class="footer-row row gy-5 g-sm-5 gx-xxl-6">
                    <div class="border-end col-lg-4 col-md-7 col-sm-6">
                        ...
                        <div class="mb-4">Join our newsletter and receive the best job<br class="d-none d-xxl-block">
                            openings of the week, right on your inbox.</div>
                        ...
                        <h5 class="fw-bold mb-4">Want to join Us?<br> Write us !</h5>
                        <span>support@gmail.com</span>
                    </div>
                    <div class="border-end col-lg-4 col-md-5 col-sm-6">
                        <h5 class="fw-bold mb-4">Stay Connect</h5>
                        <div>Institute Teknologi Batam<br class="d-none d-xxl-block"> , Tiban Ayu</div>
                        <div class="mt-4">
                ...
                <div class="col-lg order-md-first">
                    <div class="align-items-center row">
                        ...
                        <a href="index.html" class="col-sm-auto footer-logo mb-2 mb-sm-0">
                            <img src="vendor/images/logo-white.png" alt="">
                        </a>
                        <!-- end /. footer logo -->
                        <!-- start text -->
    ...
    <script src="vendor/plugins/aos/aos.min.js"></script>
    <script src="vendor/plugins/macy/macy.js"></script>
    <script src="vendor/plugins/simple-parallax/simpleParallax.min.js"></script>
    <script src="vendor/plugins/OwlCarousel2/owl.carousel.min.js"></script>
    <script src="vendor/plugins/theia-sticky-sidebar/ResizeSensor.min.js"></script>
    <script src="vendor/plugins/theia-sticky-sidebar/theia-sticky-sidebar.min.js"></script>
    <script src="vendor/plugins/waypoints/jquery.waypoints.min.js"></script>
    <script src="vendor/plugins/counter-up/jquery.counterup.min.js"></script>
    <script src="vendor/plugins/jquery-fancyfileuploader/fancy-file-uploader/jquery.ui.widget.js"></script>
    <script src="vendor/plugins/jquery-fancyfileuploader/fancy-file-uploader/jquery.fileupload.js"></script>
    <script src="vendor/plugins/jquery-fancyfileuploader/fancy-file-uploader/jquery.iframe-transport.js"></script>
    <script src="vendor/plugins/jquery-fancyfileuploader/fancy-file-uploader/jquery.fancy-fileupload.js"></script>
    <script src="vendor/plugins/ion.rangeSlider/ion.rangeSlider.min.js"></script>
