                ...
                <div class="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
                    ...
                    <div class="mb-5">
                        ...
                        <p class="mb-0">Unlock a world of exclusive content, enjoy special offers, and be the first to
                            dive into exciting news and updates by joining our community!</p>
                    </div>
                    <!-- /.End Header Text -->
                    ...
                    <!-- Start Text -->
                    <p class="mb-0">We won't post anything without your permission and your personal details are kept
                        private</p>
                    <!-- /.End Text -->
                    <!-- Start Divider -->
                    ...
                    <form class="register-form">
                        ...
                        <div class="form-check mb-4 text-start">
                            ...
                            <label class="form-check-label" for="flexCheckDefault"> By signing up, you agree to the <a href="terms-conditions.html" class="text-decoration-underline">terms of service</a>
                            </label>
                        </div>
                        <!-- /.End Checkbox -->
                        <!-- Start Button -->
            ...
            <div class="col-xl-7 d-none d-xl-block">
                <div class="background-image bg-light d-flex flex-column h-100 justify-content-center p-5 rounded-4" data-image-src="vendor/images/lines.svg">
                    <div class="py-5 text-center">
                        ...
                        <img src="vendor/images/png-img/real-time-analytics.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="py-5">
                ...
                <div class="bg-primary rounded-4">
                    <div class="col-xxl-10 col-md-11 col-10 d-flex flex-md-row flex-column-reverse align-items-md-end align-items-center mx-auto px-0 gap-4">
                        <img class="app-image flex-shrink-0" src="vendor/images/phone-mpckup.png" width="270" alt="Mobile app">
