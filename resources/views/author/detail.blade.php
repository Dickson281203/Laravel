        ...
        <div class="align-items-end row g-4 mb-4" data-aos="fade-down">
            <div class="col">
                ...
                <div class="section-header">
                    <!-- start subtitle -->
                    <div class="font-caveat fs-4 fw-bold fw-medium section-header__subtitle text-capitalize text-center text-primary text-xl-start">Author</div>
                    <!-- end /. subtitle -->
                    <!-- start title -->
                    <h2 class="fw-semibold mb-0 section-header__title text-capitalize text-center text-xl-start h3">Detail Information</h2>
                    <!-- end /. title -->
                    <!-- start description -->
                    <div class="sub-title fs-16 text-center text-xl-start">a little information about<span class="text-primary fw-semibold"> Adry Mirza</span></div>
                    <!-- end /. description -->
                </div>
                <!-- end /. section header -->
            </div>
            <div class="col-12 col-xl-auto">
                <!-- start button -->
                <a href="{{ route('author.index') }}" class="align-items-center d-flex fs-14 fw-bold gap-2 justify-content-center justify-content-xl-end l-spacing-1 text-primary text-uppercase">
                    Back to Author List Page
                ...
                <div class="g-0 h-100 row">
                    <div class="col-lg-3 col-md-5 col-sm-4 col-xxl-2 position-relative">
                        <div class="card-image-hover dark-overlay h-100 overflow-hidden position-relative">
                            <!-- start image -->
                            <img src="assets/dist/img/avatar/01.jpg" alt="" class="h-100 w-100 object-fit-cover">
                            <!-- end /. image -->
                        </div>
                    </div>
